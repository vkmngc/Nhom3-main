...
(function ($) {
    ...
    /* Plugin đếm ngược giảm giá cho trang chủ 
    Việt hoá countdown-content Days, Hours, Mins, Secs => thành Ngày, Giờ, Phút, Giây
    */
    RESHOP.timerCountDown = function () {
        // kiểm tra xem có trang có đồng hồ đếm ngược không
        if ($collectionCountDown.length) {
            $collectionCountDown.each(function () {
                // Lấy đối tượng jQuery của phần tử hiện tại
                var $this = $(this),
                    // Lấy thời điểm kết thúc đếm ngược từ thuộc tính 'data-countdown' của phần tử
                    finalDate = $(this).data('countdown');
                // Sử dụng plugin jQuery Countdown để tạo đồng hồ đếm ngược
                $this.countdown(finalDate, function (event) {
                    // Cập nhật nội dung HTML của phần tử với giá trị đếm ngược mới
